...
class EnhancedConnectionWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.set_connect_button_style(False)
    ...
    def set_connect_button_style(self, connected):
        """Set the connect button style based on connection state"""
        if connected:
    ...
    def set_connected(self, connected: bool, message: str = ""):
        ...
        if connected:
            ...
            self.set_connect_button_style(True)
